// Original by Martin Cameron, hatchet changes made by Dom. Search "copilot" or 
// "hatchet" to find areas where code has been modified
...
public class Tracker3 extends Canvas implements KeyListener, MouseListener, MouseMotionListener, WindowListener
{
 ...
 public static final String VERSION = "Tracker3.4 (apols to mumart@gmail.com)";
 ...
 public synchronized void keyPressed( KeyEvent e )
 {
   ...
   // hatchet to get modifiers working because for some reason i want this to be
   // cross platform
   ...
   */
   ...
   // end hatchet - this turned out ot be a bit of a dead end because the 
   // getMenuShortcutKeyMask of java.awt.Toolkit class seems like it might only 
   // work within the MenuComponent object. I'm just gonna hard-code the
   // shortcut keys to use Ctrl as a modifier, or maybe just any Fn keys that
   // aren't already used
   ...
   try
   {
     switch( e.getKeyCode() )
     {
         ...
         if( modPlay3.getSequencer() )
       {
         ...
         break;
         /* Cycling through patterns - this is proving a bit of a dead end
       ...
       case KeyEvent.VK_SLASH:
         ...
         if ( e.isControlDown() )
       {
         focusPatternGadget();setSelection( pat, 0, 0, 0, 0 );
         }
         break;
...
// code by Microsoft's copilot AI because I'm a hatchet-jobber
 ...
 private void cycleFocus() {
  ...
  //skip textbox and listbox gadget types 
